...
| [**Kubernetes**](#개요) |  C# .Net Framework 4.7.2  |            C#(OpenCvSharp4 - V4.5.3.20210817)            |
| [**파이프라인 구축**](#개요) |       Python 3.9.6        |                       Python(Math)                       |
|                    [**CI/CD**](#개요)                    |       Python 3.9.6        |                    Python(Shell_plus)                    |
|           [**Ingress Nginx**](#개요)           |       Django 3.2.9        |      prefetch_related / annotate / filter / exclude      |
|                  [**배포**](#개요)   |            AWS            | EC2(Ubuntu Server 20.04 LTS) / Cloud9 / Gunicorn / NGINX |
|                                                        |                           |                                                          |
|                                                        |                           |                                                          |
|                                                        |                           |                                                          |
|                                                        |                           |                                                          |
