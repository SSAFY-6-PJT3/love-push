...
//    }
    ...
    @DeleteMapping("/{commentId}/childcomments/{childCommentId}")
    public ResponseEntity<?> deleteChildComment(@PathVariable("childCommentId") Long childCommentId) {
        return feedService.deleteChildComment(childCommentId);
    }
}
